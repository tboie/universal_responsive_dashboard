...
// UNIVERSAL RESPONSIVE DASHBOARD - POC v1 (something to work with)

export const CORNER_SIZE = 0.25;
...
export const RESIZE_UNIT = (u: T, dim: "w" | "h", val: number) => {
...
export const ADD_RESIZE_OBSERVER = (i: number) => {
...
export const REMOVE_RESIZE_OBSERVER = (i: number) => {
  const ele = document.getElementById(`#U${i}`);
  if (ele) {
...
const DESIGNER = () => {
  const [UNITS, SET_UNITS] = useState(D);
